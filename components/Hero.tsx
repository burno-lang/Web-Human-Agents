...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute top-1/2 -right-20 w-96 h-96 bg-teal-500/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#agenda" 
              className="group flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl text-lg font-bold transition-all hover:scale-105 shadow-lg shadow-blue-900/20"
            >
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-slate-800 pt-12">
            <div>
              <div className="text-3xl font-bold font-jakarta">+30%</div>
              <div className="text-slate-500 text-sm mt-1">Asistencia a llamadas</div>
            </div>
            <div>
              <div className="text-3xl font-bold font-jakarta">24/7</div>
              <div className="text-slate-500 text-sm mt-1">Atención Inmediata</div>
            </div>
            <div>
              <div className="text-3xl font-bold font-jakarta">0s</div>
              <div className="text-slate-500 text-sm mt-1">Carga de CRM</div>
            </div>
            <div>
              <div className="text-3xl font-bold font-jakarta">100%</div>
